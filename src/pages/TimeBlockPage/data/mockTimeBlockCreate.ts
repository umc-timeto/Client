...
export const mockTasks: TaskItem[] = [
  { id: "t1", title: "1과목 핵심 암기", folderId: "f1", minutes: 30, level: "mid", colorKey: "yellow" },
  ...
  { id: "t11", title: "식단 기록 작성", folderId: "f11", minutes: 20, level: "low", colorKey: "lightGreen" },

  { id: "t12", title: "읽을 책 10페이지", folderId: "f12", minutes: 30, level: "mid", colorKey: "purple" },
